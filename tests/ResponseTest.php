...
class ResponseTest extends TestCase
{
    ...
    {
        $data = '{"response_code":802,"response_status":"SUCCESS_MESSAGE_PARTIAL_ACCEPTED","response_result":[{"phone":"\u043e\u0442\u0440\u0438\u043c\u0443\u0432\u0430\u0447_1","response_code":406,"message_id":null,"response_status":"NOT_ALLOWED_RECIPIENT_COUNTRY"},{"phone":"\u043e\u0442\u0440\u0438\u043c\u0443\u0432\u0430\u0447_2","response_code":0,"message_id":"f83f8868-5e46-c6cf-e4fb-615e5a293754","response_status":"OK"}]}';
        $response = new Response($data, ResponseMessage::class, 'response_result');
